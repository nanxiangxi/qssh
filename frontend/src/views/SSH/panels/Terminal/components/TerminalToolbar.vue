...
.terminal-toolbar {
  ...
  padding: 0 10px; background: var(--bg-toolbar); border-bottom: 1px solid var(--border-default); flex-shrink: 0;
}
...
.status-indicator { display: flex; align-items: center; gap: 4px; padding: 2px 6px; border-radius: 3px; background: var(--surface-2); }
.status-dot { width: 7px; height: 7px; border-radius: 50%; flex-shrink: 0; }
.status-indicator.active .status-dot { background: var(--accent-success); box-shadow: 0 0 5px color-mix(in srgb, var(--accent-success), transparent 60%); }
...
.status-indicator.idle .status-dot { background: var(--text-disabled); }
.status-text { font-size: 12px; color: var(--text-secondary); }
.session-label { font-size: 11px; color: var(--text-muted); padding: 1px 5px; background: var(--surface-2); border-radius: 3px; }
.command-count { font-size: 11px; color: var(--text-disabled); }
.toolbar-btn {
...
.toolbar-btn.recording { background: var(--danger-bg); color: var(--accent-danger); }
.toolbar-btn.reconnect { background: var(--warning-bg); color: var(--accent-warning); }
...
.save-menu {
  ...
  background: var(--bg-panel); border: 1px solid var(--border-default); border-radius: 4px;
  padding: 2px; min-width: 120px; box-shadow: var(--shadow-md); z-index: 100;
}
.save-option { padding: 4px 10px; font-size: 12px; color: var(--text-secondary); cursor: pointer; border-radius: 3px; }
.save-option:hover { background: var(--bg-hover); color: var(--text-primary); }
